...
async function tablaProfesor() {
    ...
    const urlLimite = `http://localhost/Sitio_Liceo_Nº1/PHP/Opciones/Estudiante.php?paginado=limitePaginadoEstudiante`;
    ...
    function crearBotones(i) {
        ...
        boton.onclick = async () => {
            ...
            const urlPaginado = `http://localhost/Sitio_Liceo_Nº1/PHP/Opciones/Estudiante.php?paginado=paginadoEstudiante&cantidad=${limitePaginado}`;
            ...
            datosPaginado.forEach(Datos => {
                ...
                celdaCi.textContent = Datos.Ci_e;
...
async function actualizarFiltrado() {
    ...
    if (inputCedula.value == "" && inputNombre.value == "" && inputApellido.value == "") {
        ...
        const urlFiltrado = `http://localhost/Sitio_Liceo_Nº1/PHP/Opciones/Estudiante.php?filtrado=filtradoEstudiante&cedula=${cedula}&nombre=${nombre}&apellido=${apellido}`;
        ...
        try{
                ...
                alert("Ningun estudiante encontrado");
                inputCedula.value = '';
                inputNombre.value = '';
                inputApellido.value = '';
