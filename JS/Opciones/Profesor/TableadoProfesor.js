...
async function tablaProfesor() {
    ...
    const urlLimite = `http://localhost/Sitio_Liceo_Nº1/PHP/Opciones/Profesor.php?paginado=limitePaginadoProfesor`;
    ...
    function crearBotones(i) {
        ...
        boton.onclick = async () => {
            ...
            const urlPaginado = `http://localhost/Sitio_Liceo_Nº1/PHP/Opciones/Profesor.php?paginado=paginadoProfesor&cantidad=${limitePaginado}`;
            ...
            datosPaginado.forEach(Datos => {
                ...
                celdaCi.textContent = Datos.Ci_p;
...
async function actualizarFiltrado() {
    ...
    if (inputCedula.value == "" && inputNombre.value == "" && inputApellido.value == "") {
        ...
        const urlFiltrado = `http://localhost/Sitio_Liceo_Nº1/PHP/Opciones/Profesor.php?filtrado=filtradoProfesor&cedula=${cedula}&nombre=${nombre}&apellido=${apellido}`;
        ...
        try{
                ...
                alert("Ningun profesor encontrado");
                inputCedula.value = '';
                inputNombre.value = '';
                inputApellido.value = '';
